...
class Endpoint:
    ...
    requires_model_kind: Optional[str] = None  # "chat" | "embed" | "asr" | …
    notes: str = ""
...
ENDPOINTS: list[Endpoint] = [
    # --- models / discovery ---------------------------------------------
    Endpoint(
        path="/v1/models", method="GET", group="models", kind="core",
        expects=("data",),
        notes="discovery; required for any compat surface",
    ),
    Endpoint(
        path="/v1/models/{model}", method="GET", group="models", kind="core",
        expects=("id", "object"),
    ...
    # --- chat / completions ---------------------------------------------
    Endpoint(
        path="/v1/chat/completions", method="POST", group="chat", kind="core",
        body={"model": "{model}",
    ...
    Endpoint(
        path="/v1/chat/completions[stream]", method="POST", group="chat",
        kind="core",
        body={"model": "{model}",
              "messages": [{"role": "user", "content": "hi"}],
    ...
    Endpoint(
        path="/v1/completions", method="POST", group="chat", kind="ext",
    ...
    Endpoint(
        path="/v1/responses", method="POST", group="chat", kind="ext",
    ...
    # --- embeddings ------------------------------------------------------
    Endpoint(
        path="/v1/embeddings", method="POST", group="embed", kind="core",
        body={"model": "{model}", "input": "hi"},
    ...
    # --- audio: STT ------------------------------------------------------
    Endpoint(
        path="/v1/audio/transcriptions", method="POST", group="audio-stt",
        kind="core", multipart=True,
        body={"model": "{model}", "response_format": "json"},
        expects=("text",),
        requires_model_kind="asr",
    ),
    Endpoint(
        path="/v1/audio/translations", method="POST", group="audio-stt",
        kind="ext", multipart=True,
        body={"model": "{model}", "response_format": "json"},
        expects=("text",),
        requires_model_kind="asr",
    ...
    # --- audio: TTS ------------------------------------------------------
    Endpoint(
        path="/v1/audio/speech", method="POST", group="audio-tts",
        kind="core",
    ...
    Endpoint(
        path="/v1/audio/voices", method="GET", group="audio-tts", kind="ext",
        expects=("voices",),
    ...
    # --- images ----------------------------------------------------------
    Endpoint(
        path="/v1/images/generations", method="POST", group="images",
        kind="core",
        body={"model": "{model}", "prompt": "a red dot",
              "n": 1, "size": "256x256", "response_format": "b64_json"},
        expects=("data.0",),
        requires_model_kind="image",
    ),
    Endpoint(
        path="/v1/images/edits", method="POST", group="images",
        kind="ext", multipart=True,
        body={"model": "{model}", "prompt": "make it blue",
              "n": 1, "size": "256x256", "response_format": "b64_json"},
        expects=("data.0",),
    ...
    Endpoint(
        path="/v1/images/variations", method="POST", group="images",
        kind="ext", multipart=True,
        body={"model": "{model}", "n": 1, "size": "256x256",
    ...
    # --- moderations -----------------------------------------------------
    Endpoint(
        path="/v1/moderations", method="POST", group="moderations",
        kind="ext",
    ...
    Endpoint(
        path="/v1/files", method="GET", group="files", kind="ext",
        expects=("data",),
        notes="OpenAI Files API; usually absent in OSS shims",
    ),
    Endpoint(
        path="/v1/batches", method="GET", group="batches", kind="ext",
        expects=("data",),
        notes="OpenAI Batch API; usually absent in OSS shims",
    ),
    Endpoint(
        path="/v1/uploads", method="GET", group="files", kind="ext",
        expects=(),
    ...
    # --- our extensions --------------------------------------------------
    Endpoint(
        path="/v1/videos", method="POST", group="video", kind="ours",
        body={"model": "{model}", "prompt": "a slow zoom on a red dot",
              "seconds": 1},
        expects=("id", "status"),
